...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    if (pindexLast->nHeight+1 > Params().GetConsensus().nV014v1Start && pindexLast->nHeight+1 < Params().GetConsensus().nV014v1Start+30000 && pblock->GetBlockTime() > pindexLast->GetBlockTime() + params.nPowTargetSpacing*2) {
