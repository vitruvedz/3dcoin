...
bool TestBlockv2Validity(CValidationState& state, const CChainParams& chainparams, const CBlockv2& blockv2, CBlockIndex* pindexPrev, bool fCheckPOW = true, bool fCheckMerkleRoot = true);
