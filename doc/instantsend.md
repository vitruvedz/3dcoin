...
* WebSocket: [https://github.com/blockchaintechllc/insight-api#web-socket-api](https://github.com/blockchaintechllc/insight-api#web-socket-api) 
* API: [https://github.com/BlockchainTechLLC/insight-api#instantsend-transactions](https://github.com/BlockchainTechLLC/insight-api#instantsend-transactions) 
...
By default, the 3DCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the 3DCoin Core daemon:
