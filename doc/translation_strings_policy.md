...
This document provides guidelines for internationalization of the 3DCoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to 3DCoin network</numerusform>
            <numerusform>%n active connections to 3DCoin network</numerusform>
        </translation>
    </message>
