...
Only requiring some minor changes is 3dcoin.cpp.
...
Changes to 3dcoin.cpp
----------------------
3dcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
